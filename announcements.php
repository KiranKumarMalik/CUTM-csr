...
<head>
    ...
    <title>CUTM | CSaR | Announcements </title>
...
<section
    ...
    <div class="text-center">
        <h2
            ...
            <strong>ANNOUNCEMENTS AND EVENTS</strong><br></h2>
        <hr
            data-aos="fade-up"
        ...
        <div class="card">
            <div class="card-body">
                ...
                foreach($findbbsr as $bbsrcamp)
                {
                    ...
                    <p data-aos="fade-up" style="text-align:left">Publish Time <?=$bbsrcamp['publishtime']?></p>
                    <?=$bbsrcamp['details']?><br>
                    <br>
                    <a href="announcement details.php?id=<?=$bbsrcamp['id']?>">
                        <p data-aos="fade-up" style="text-align:right">Read more <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
        ...
        <div class="card">
            <div class="card-body">
                ...
                foreach($findbls as $blscamp)
                {
                    ...
                    <p data-aos="fade-up"><?=$blscamp['details']?></p><br>
                    <p data-aos="fade-up">Publish Time<?=$blscamp['details']?></p><br>
