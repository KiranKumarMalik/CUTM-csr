...
<head>
    ...
    <title>CUTM | CSaR | Co-ordinators </title>
...
<body style="height: auto;">
    <header>
            ...
            <div class="container"><a class="navbar-brand" href="#"><img src="assets/img/logo/logo.png" alt="Logo" width="74" height="100"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse"
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger scrollto" href="index.php">HOME</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-triggerscrollto" href="aboutus.php">ABOUT</a></li>
        ...
        <section id="pricing" class="pricing" style="margin-top: 20px;margin-bottom: 20px;">
                    ...
                    <h2 class="text-center section-title" data-aos="fade-up" style="padding-top: 145px;padding-bottom: 0px;"><strong>Club In-Charges of <?=$campus?> Campus</strong><br></h2>
