...
<head>
    ...
    <title>CUTM | CSaR | Achievements </title>
...
<body style="height: auto;">
    <header>
        ...
        <section id="pricing" class="pricing" style="margin-top: 20px;margin-bottom: 20px;">
                    ...
                    <h2 class="text-center section-title" data-aos="fade-up" style="padding-top: 145px;padding-bottom: 0px;"><strong>Achievements of <?=$campus=$_GET['campus']?> Campus</strong><br></h2>
                    ...
                    <li data-aos="fade-up"><a href="prevachievements.php?coordinator=ClubInCharges&campus=<?=$campus?>"> 2015-16</a></li>
                    <li data-aos="fade-up"><a href="prevachievements.php?coordinator=FacultyInCharges&campus=<?=$campus?>"> 2016-17</a></li>
                    <li data-aos="fade-up"><a href="prevachievements.php?coordinator=StudentInCharges&campus=<?=$campus?>"> 2017-18</a></li><br>
                    </div>
                    </div>
    </section>
    <!-- End: #co-ordinators -->
