...
<body style="height: auto;">
    <header id="header" class="main-header" style="background: url(&quot;assets/img/cutmbg.jpg?h=4b69291c09f7598206c94cbd642abc27&quot;) center / cover no-repeat;height: 690px;">
    ...
    <section id="about-us" class="about-us" style="padding-bottom: 50px;">
      ...
      <div class="announcements" style="padding-top: 0px">
        ...
        <div class='marquee-hsas-shortcode-88' style='width: 100%;overflow: hidden;'>        <!-- </marquee> -->
        </div>
        </div>
    </div>
</div>    
<!-- End Top Bar -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                    <div>
                        <h1 data-aos="fade-up" style="color: #002654;"><strong>CULTURE SPORTS AND RESPONSIBILITY</strong></h1>
                        ...
                        <p data-aos="fade-up">It is part of our curriculum that all students of centurion University of Technology and Management will now be required to participate in the Culture, Sports, and responsibility (CSR) program during their studies at CUTM w.e.f. 2011-12 academic year.</p><a class="btn btn-info about-us-btn" role="button" data-aos="fade-up"
                            href="aboutus.php" style="width: 150px;">More About Us</a></div>
                </div>
            </div>
        </div>
    </section>
    <!-- End: #about -->
    <!-- Start: Clubs -->
    <section id="services" class="services" style="margin-top: 20px;margin-bottom: 20px;background: rgba(240,249,255,0.6);">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-lg-4 col-md-6 icon-box" data-aos="fade-up" style="margin-top: 20px;margin-bottom: 20px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                        <div class="member">
                            <div class="member-img"><img class="img-fluid" src="assets/img/team/sangram1.png?h=63ff35667fd20fc8d734752b7311ed81"></div>
                            <div class="social"><a href="#"><i class="fab fa-facebook"></i></a><a href="#"><i class="fab fa-twitter"></i></a><a href="#"><i class="fab fa-instagram"></i></a><a href="#"><i class="fab fa-linkedin-in"></i></a></div>
                            <div class="member-info">
                                <h5><strong>Dr. Sangram Keshari Swain</strong></h5><span>Head of the CSaR</span></div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                        <div class="member">
                            <div class="member-img"><img class="img-fluid" src="assets/img/team/bikash.jpeg?h=5d89eb647c2023c1188505e36fe3a8a7"></div>
                            <div class="social"><a href="#"><i class="fab fa-facebook"></i></a><a href="#"><i class="fab fa-twitter"></i></a><a href="#"><i class="fab fa-instagram"></i></a><a href="#"><i class="fab fa-linkedin-in"></i></a></div>
                            <div class="member-info">
                                <h5><strong>Bikash Samantaray</strong></h5><span>Head of the Culture Club</span></div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <div class="member-img"><img class="img-fluid" src="assets/img/team/rabi1.jpeg?h=6aa922960cedd9601f370b1ef9a1889b"></div>
                            <div class="social"><a href="#"><i class="fab fa-facebook"></i></a><a href="#"><i class="fab fa-twitter"></i></a><a href="#"><i class="fab fa-instagram"></i></a><a href="#"><i class="fab fa-linkedin-in"></i></a></div>
                            <div class="member-info">
                                <h5><strong>Rabi Narayan Routray</strong></h5><span>Head of the Sports Club</span></div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
                        <div class="member">
                            <div class="member-img"><img class="img-fluid" src="assets/img/team/kula.jpeg?h=e6327a565d06c34455a63fad12fbff94"></div>
                            <div class="social"><a href="#"><i class="fab fa-facebook"></i></a><a href="#"><i class="fab fa-twitter"></i></a><a href="#"><i class="fab fa-instagram"></i></a><a href="#"><i class="fab fa-linkedin-in"></i></a></div>
                            <div class="member-info">
                                <h5><strong>Kula Bhusan Pradhan</strong></h5><span>Head of the Responsibility Club</span></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="portfolio" class="portfolio">
        <div class="container">
            <div class="text-center section-title" style="padding-bottom: 0px;">
                <h3 class="text-uppercase" data-aos="fade-up" style="padding-top: 30px;">Image&nbsp;<span style="color: #f96302;"><strong>Gallery</strong></span></h3>
            </div>
            <hr data-aos="fade-up" style="width: 120px;border-bottom-style: none;padding-bottom: 30px;">
            <div class="row">
    ...
    <section id="pricing" class="pricing" style="margin-top: 20px;margin-bottom: 20px;">
        <div class="text-center">
            <h2 class="text-center section-title" data-aos="fade-up" style="padding-top: 20px;padding-bottom: 0px;"><strong>Campus</strong><br></h2>
            <hr data-aos="fade-up" style="width: 120px;border-bottom-style: none;padding-bottom: 30px;">
            <div class="container">
                <div class="row">
        ...
        <div class="container modern-form">
            ...
            <div class="row text-center" style="background-color: #ffffff;">
                <div class="col-6 col-sm-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
                    <div><i class="icon ion-ios-location get-in-touch-icons" style="font-size: 40px;color: #f95602;"></i>
                ...
                <div class="col-6 col-sm-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
                    <div><i class="icon ion-ios-time get-in-touch-icons" style="font-size: 40px;color: #f95602;"></i>
                ...
                <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
                    <div><i class="icon ion-android-mail get-in-touch-icons" style="font-size: 40px;color: #f95602;"></i>
                ...
                <div class="col-6 col-sm-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
                    <div><i class="icon ion-ios-telephone get-in-touch-icons" style="font-size: 40px;color: #f95602;"></i>
