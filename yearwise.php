...
$campus=$_GET['campus'];
$getImage=getgallery1($db,$campus);
...
<head>
    ...
    <title>CUTM | CSaR | Image Gallery | Years</title>
            ...
            <div class="container"><a class="navbar-brand" href="#"><img src="assets/img/logo/logo.png" alt="Logo" width="74" height="100"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse"
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger scrollto" href="index.php">HOME</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link active scrollto" href="imagegallery.php">GALLERY</a></li>
            ...
            <div class="row">
                <div class="col col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        <li class="filter-active" data-filter="*">Years&nbsp;</li>
                        </ul>
                </div>
            </div>
        </div>
...
?>
                <a href="eventwise.php?year=<?=$getImages['years']?>&campus=<?=$campus?>">
