...
<img src="../images/profileimg/<?=$adminData['profileimg'] ?>" alt="<?=$adminData ?>" width="170" height="170"ALIGN="right"HSPACE="30"VSPACE="30"style=border-radius:50%;/>
  <br><b>Name:</b> <?=$adminData['name']?></br>
  <br><b>Designation:</b> <?=$adminData['designation']?></br>
  <br><b>Campus:</b> <?=$adminData['campus']?></br>
  <br><b>Sex:</b> <?=$adminData['sex']?></br>
