...
if($_SESSION['email'] and $utype=="student")
{
  ...
  $today=date("Y-m");
  $emableBtnMonth=$AddmissionYear+$studentdata['courseDuration']."-06";
  echo $today;
  echo $emableBtnMonth;
  $mybtmis="";
  if ($today<$emableBtnMonth) {
    $mybtmis="disabled";
  }
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            <a href="prof.php"><img src="../images/profileimg/<?=$studentdata['profileimage']?>"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="regd" value="<?=$studentdata['regd']?>"
                                readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="regd"
                                value="<?=$studentdata['admissionyear']?>" readonly>
                        </div>
                    </div>
