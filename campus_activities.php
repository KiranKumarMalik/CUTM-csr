...
<body style="height: auto;">
            ...
            <div class="container"><a class="navbar-brand" href="#"><img src="assets/img/logo/cutm_logo.png" alt="Logo" width="74" height="100"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li class="nav-item"><a class="nav-link scrollto active" href="campus_activities.php">ACTIVITIES</a></li>
    ...
    <section id="pricing" class="pricing" style="margin-top: 20px;margin-bottom: 20px;">
        <div class="text-center">
            <h2 class="text-center section-title" data-aos="fade-up" style="padding-top: 125px;padding-bottom: 0px;"><strong>Campus Activities</strong><br></h2>
                    ...
                    <div class="col-lg-3 col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100" style="margin-top: 15px;margin-bottom: 15px;">
                        <div class="card shadow" style="width: 277.5;">
                            <div class="card-body" style="padding: 0px;padding-right: 0px;padding-left: 0px10px;width: 100%;background: #fff1dc;">
                                <i class="fa fa-table fa-5x" style="color:#273746"></i>
                                <h4 class="card-title" style="margin-top: 20px;"><strong>Balasore</strong></h4>
                                <div><a href="./yearwise_activities.php?campus=Balasore"><button class="btn btn-warning text-white pricing-btn" type="button">More details</button></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100" style="margin-top: 15px;margin-bottom: 15px;">
                        <div class="card shadow" style="width: 277.5;">
                            ...
                            <i class="fa fa-table fa-5x" style="color:#273746"></i>
                                ...
                                <div><a href="./yearwise_activities.php?campus=Bhubaneswar"><button class="btn btn-warning text-white pricing-btn" type="button">More details</button></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200" style="margin-top: 15px;margin-bottom: 15px;">
                        <div class="card shadow" style="width: 277.5;">
                            ...
                            <i class="fa fa-table fa-5x" style="color:#273746"></i>
                                ...
                                <div><a href="./yearwise_activities.php?campus=Balangir"><button class="btn btn-warning text-white pricing-btn" type="button">More details</button></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300" style="margin-top: 15px;margin-bottom: 15px;">
                        <div class="card shadow" style="width: 277.5;">
                            ...
                            <i class="fa fa-table fa-5x" style="color:#273746"></i>
                                ...
                                <div><a href="./yearwise_activities.php?campus=Paralakhemundi"><button class="btn btn-warning text-white pricing-btn" type="button">More details</button></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="400" style="margin-top: 15px;margin-bottom: 15px;">
                        <div class="card shadow" style="width: 277.5;">
                            ...
                            <i class="fa fa-table fa-5x" style="color:#273746"></i>
                                ...
                                <div><a href="./yearwise_activities.php?campus=Rayagada"><button class="btn btn-warning text-white pricing-btn" type="button">More details</button></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300" style="margin-top: 15px;margin-bottom: 15px;">
                        <div class="card shadow" style="width: 277.5;">
                            ...
                            <i class="fa fa-table fa-5x" style="color:#273746"></i>
                                ...
                                <div><a href="./yearwise_activities.php?campus=Chatrapur"><button class="btn btn-warning text-white pricing-btn" type="button">More details</button></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="400" style="margin-top: 15px;margin-bottom: 15px;">
                        <div class="card shadow" style="width: 277.5;">
                            ...
                            <i class="fa fa-table fa-5x" style="color:#273746"></i>
                                ...
                                <div><a href="./yearwise_activities.php?campus=Vizianagaram"><button class="btn btn-warning text-white pricing-btn" type="button">More details</button></a></div>
                            </div>
                        </div>
                    </div>
                </div>
