  ...
  $.ajax({
    ...
    success : function(r) {
      ...
      if(r.error == 'NO_RECORD') {
        ...
        $('#pie').html('<br><br><h2>Percent : </h2> <input class="knob" value="'+(Math.floor(r.percent))+'" data-readonly="true" data-thickness=".4" readonly="readonly" data-width="150" data-height="150" data-angleOffset=180 data-fgColor="#87AB66" data-bgColor="#E1EAD9"><br><br>');
        loadKnob();
        return;
      }
    },
